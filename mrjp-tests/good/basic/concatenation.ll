...
@.str2 = private constant [2 x i8] c"b\00"
define i64 @main() {
	%var1 = call i8* @calloc(i64 2, i64 1)
	call void @memcpy(i8* %var1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str1, i64 0, i64 0), i64 2)
	%var2 = call i8* @calloc(i64 2, i64 1)
	call void @memcpy(i8* %var2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str2, i64 0, i64 0), i64 2)
	%var3 = call i8* @concat_strings(i8* %var1, i8* %var2)
