...
@.str1 = private constant [168 x i8] c"\"\npop\npowrot:\ngetstatic java/lang/System/out Ljava/io/PrintStream;\nldc \"zle \"\ninvokevirtual java/io/PrintStream/print(Ljava/lang/String;)V\ngoto powrot\nldc \"\00"
define i64 @f(i64 %p) {
	%var1 = alloca i64
	store i64 %p, i64* %var1
	%var3 = load i64, i64* %var1
	%var2 = mul i64 2, %var3
	%var5 = load i64, i64* %var1
	%var4 = add i64 %var5, %var2
	%var6 = alloca i64
	store i64 %var4, i64* %var6
	%var7 = call i8* @calloc(i64 157, i64 1)
	call void @memcpy(i8* %var7, i8* getelementptr inbounds ([157 x i8], [157 x i8]* @.str1, i64 0, i64 0), i64 157)
	call void @printString(i8* %var7)
	%var8 = load i64, i64* %var6
	ret i64 %var8
}

define i64 @main() {
%var1 = call i64 @f(i64 1)
	%var2 = sub i64 %var1, 3
	ret i64 %var2
}
