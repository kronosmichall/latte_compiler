...
@.str1 = private constant [14 x i8] c"\\a\\n\n\tb\"\00"
define i64 @main() {
	%var1 = call i8* @calloc(i64 9, i64 1)
	call void @memcpy(i8* %var1, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str1, i64 0, i64 0), i64 9)
