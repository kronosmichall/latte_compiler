...
@.str1 = private constant [12 x i8] c"jeszcze raz\00"
define i64 @main() {
	br label %1
; <label>:1
	br label %2
...
%var2 = call i64 @readInt()
	...
	%var3 = icmp eq i64 %var4, 1
	br i1 %var3, label %3, label %4
; <label>:3
	ret i64 0
	br label %5
; <label>:4
	%var5 = call i8* @calloc(i64 12, i64 1)
	call void @memcpy(i8* %var5, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str1, i64 0, i64 0), i64 12)
